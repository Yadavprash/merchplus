...
const ProductCard = ({ product }:{product : Product}) => {
  ...
  return (
    <div className="bg-white   m-1 overflow-hidden"
      ...
      width={380}
      height={480}
      className=" w-full rounded-md h-[300px] object-cover transition-opacity duration-300"
      />
      <div className="flex justify-between pt-4 px-2">
        <h2 className="text-lg text-wrap font-sans text-sm mb-2">{product.name.length > 50 ? product.name.substring(0,50) : product.name}</h2>
