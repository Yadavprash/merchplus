        ...
        >
          <div className="p-4 ">
            ...
            <div className="overflow-y-auto h-full">
              <Filters categories={categories} products={filteredProducts} setFilteredProducts={setFilteredProducts}></Filters>
            </div>
          </div>
        </div>
      </div>
      <AppBar setProducts={setFilteredProducts} />
        ...
        <div className="flex  flex-col w-2/3 ">
          ...
          <div className=' flex  justify-between items-center font-sans text-sm'>
            <div className='flex space-x-2'>
              ...
              <SortProducts products={filteredProducts} setProducts={setFilteredProducts}></SortProducts>
            </div>
